...
IP_ADDR server;
// Puerto TCP.
#define EXAMPLE_TCP_PORT   (int16)123
//int reintento_envio;
...
void ticket(){//U1PRINTER //HHMMSSFFFFFFFFZ
   ...
   */
   ...
   LF();
   ///////////////////////////////////////////////////////////
   fprintf(U1PRINTER,"ESTACIONAMIENTO PRUEBA");
   //printf("\x0A");//limpia la justificación 
   ////desactiva negritas
   fprintf(U1PRINTER,"\x1B");
   fprintf(U1PRINTER,"G");
   ...
   /////
   fprintf(U1PRINTER,"\x0A");//limpia la justificación
   //fprintf(U1PRINTER,"Av. Mexico No. 700 Ofna. 308 \x0ACol. San Jeronimo Aculco,C.P. 10200. \x0ADelegacion:Magdalena Contreras, Ciudad de Mexico \x0A");
   fprintf(U1PRINTER,"Calle  27  Oriente  No. 15   \x0ACol. El Carmen, C.P. 72530. \x0APuebla, Puebla \x0A");
   ///size
   fprintf(U1PRINTER,"\x1D");
   fprintf(U1PRINTER,"!");
   fputc(17, U1PRINTER);
   ...
   barra1();
   fprintf(U1PRINTER,"\x0A");//limpia la justificación
   fprintf(U1PRINTER,"TARIFA:$24 Hora o Fraccion                     \x0A");
   //fprintf(U1PRINTER,"TOLERANCIA:5 MINUTOS DESPUES DE LA PRIMERA HORA\x0A");
   fprintf(U1PRINTER,"Horarios: DE 7:00 a 21:00                      \x0A");
...
///////////////////
   ...
   fprintf(U1PRINTER,"\x0A");//limpia la justificación
   fprintf(U1PRINTER,"\x0A");//limpia la justificación
   fprintf(U1PRINTER,"Este boleto ampara su seguro de viajero ");
   fprintf(U1PRINTER,"\x0A");//limpia la justificación
   fprintf(U1PRINTER,"¡EXIJALO!");
   fprintf(U1PRINTER,"\x0A");//limpia la justificación
   fprintf(U1PRINTER,"\x0A");//limpia la justificación
